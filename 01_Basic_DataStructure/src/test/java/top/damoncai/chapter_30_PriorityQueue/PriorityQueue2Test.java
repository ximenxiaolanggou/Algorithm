...
class PriorityQueue2Test {
    @Test
    public void test() {
        PriorityQueue2<Entry> priorityQueue = new PriorityQueue2<Entry>(5);

        priorityQueue.offer(new Entry("task1", 2));
        priorityQueue.offer(new Entry("task2", 8));
        priorityQueue.offer(new Entry("task3", 3));
        ...
        Assertions.assertEquals(priorityQueue.poll().getPriority(), 3);
